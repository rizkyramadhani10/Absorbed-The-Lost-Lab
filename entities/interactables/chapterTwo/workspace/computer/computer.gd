...
# 🔥 TAMBAHAN: Variabel untuk memajukan progres cerita
@export var advance_story_to: GameState.StoryStage = GameState.StoryStage.POST_SHOWER # Silakan sesuaikan default-nya di Inspector
